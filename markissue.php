...
<head>
	...
	<title>PC Care | Mark Issue Resolved</title>
</head>
<body>
	<div class="container">
		<div id="head-navbar">
			<div id="logo" class="menu inline">
				<h3 style="margin:0px;">PC Care | Mark Issue Resolved</h3>
			</div>
	    ...
	    <div class="row give-top-margin">
			<div class="col-sm-2 col-sm-offset-5">
						<form method="post" action="markissue.php">
							...
							<button type="submit" name="submit" class="btn btn-primary" value="submit">Resolve Issue</button>
						</form>
