		...
		if($_SESSION['login']){
			if(isset($_SESSION['username'])){
				if(isset($_POST['submit'])){
					...
					$userid = $row['id'];
					$query = "INSERT INTO complaints (heading, subheading, text, user_id) 
...
<head>
	...
	<title>PC Care | New Issue</title>
</head>
<body>
	<div class="container">
		<div id="head-navbar">
			<div id="logo" class="menu inline">
				<h3 style="margin:0px;">PC Care | Register an Issue</h3>
			</div>
	    ...
	    <div class="row give-top-margin">
			<div class="col-sm-8 col-sm-offset-2">
						<form method="post" action="newissue.php">
							...
							<button type="submit" name="submit" class="btn btn-primary" value="submit">Generate Issue</button>
						</form>
